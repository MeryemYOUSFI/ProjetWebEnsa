  ...
  "stringMap":[ {
    ...
    "replace" : "next"
        ...
        header.masthead {
            ...
            background: linear-gradient(to bottom, rgb(77 66 92 / 80%) 0%, rgba(17, 41, 66, 0.8) 100%), url(../assets/img/bg-masthead.jpg);;
            background-position: center;
            background-repeat: no-repeat;
        ...
        <div class="container px-4 px-lg-5">
            ...
            <div class="collapse navbar-collapse" id="navbarResponsive">
                <ul class="navbar-nav ms-auto my-2 my-lg-0">
                    ...
                    @else
                    <li class="nav-item"><a class="nav-link" href="{{ route('login') }}">S'authentifier</a></li>
        ...
        <div class="container px-4 px-lg-5 h-100">
            <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                <div class="col-lg-8 align-self-end">
                    <h1 class="text-white font-weight-bold">Bienvenue Plateform Gestion Professeur</h1>
                   
                </div>
                <div class="col-lg-8 align-self-baseline">
                    
                    <a class="btn btn-primary btn-xl" href="{{ route('login') }}">S'authentifier</a><br><br><br>
                    <a class="btn btn-primary btn-xl" href="{{ route('register') }}">S'enregistrer</a>
                </div>
